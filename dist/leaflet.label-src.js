...
(function (factory, window) {
    ...
    L.BaseMarkerMethods = {
        ...
        _addLabelRevealHandlers: function () {
            this
                ...
                .on('mousemove', this.keepLabelOpened, this);
        ...
        _removeLabelRevealHandlers: function () {
            this
                ...
                .off('mousemove', this.keepLabelOpened, this);
        ...
        _moveLabel: function (e) {
            ...
            if (!noHide) {
                ...
                this._hideLabelTimer = setTimeout(this.hideLabel, 2000)
            }
        }
    };
    ...
    L.Path.include({
        ...
        _showLabel: function (e) {
            ...
            this._hideLabelTimer = setTimeout(_hideLabel, 2000);
        },
